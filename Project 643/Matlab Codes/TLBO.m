function [bestsol,bestfitness,BestFitIter,P,f] = TLBO(prob,lb,ub,Np,T,covariance_matrix,expected_returns)
...
for t = 1: T
    ...
    for i = 1:Np
        ...
        fnew = prob(Xnew,covariance_matrix,expected_returns);          % Evaluating the fitness of the newly generated solution
