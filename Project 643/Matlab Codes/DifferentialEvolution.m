function [bestsol,bestfitness,BestFitIter,P,f] = DifferentialEvolution(prob,lb,ub,Np,T,Pc,F,covariance_matrix,expected_returns)
...
for p = 1:Np
    f(p) = prob(P(p,:),covariance_matrix,expected_returns);           % Evaluating the fitness function of the initial population
end
...
for t = 1: T
    ...
    for j = 1:Np
        ...
        fu(j) = prob(U(j,:),covariance_matrix,expected_returns);                   % Evaluating the fitness of the trial solution
