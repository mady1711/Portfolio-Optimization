function [bestsol,bestfitness,BestFitIter,P,f] = PSO(prob,lb,ub,Np,T,w,c1,c2,covariance_matrix,expected_returns)
...
for t = 1:T
    ...
    for p = 1:Np
        ...
        f(p) = prob(P(p,:),covariance_matrix,expected_returns);        % Determining the fitness of the new solution
